...
public slots:
     ...
     */
    inline int toInt(bool *ok = nullptr) const { return variant.toInt(ok); }
    /**
     * @brief Constructs a new variant with an int value.
     */
    inline void setInt(int value) { variant = value; }
    /**
     ...
     */
    inline double toDouble(bool *ok = nullptr) const { return variant.toDouble(ok); }
    /**
     * @brief Constructs a new variant with an double value.
     */
    inline void setDouble(double value) { variant = value; }
    /**
     ...
     * @param If ok is non-null: *ok is set to true if the value could be converted to an int; otherwise *ok is set to false.
     */
    inline qlonglong toLongLong(bool *ok = nullptr) const { return variant.toLongLong(ok); }
    /**
     * @brief Constructs a new variant with an qlonglong value.
     */
    inline void setLongLong(qlonglong value) { variant = value; }
    /**
     ...
     */
    inline QString toString() const { return variant.toString(); }
    /**
     * @brief Constructs a new variant with an QString value.
     */
    inline void setString(const QString &value) { variant = value; }
};
